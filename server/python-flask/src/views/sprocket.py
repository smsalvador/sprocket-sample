...
from src.schemas import SprocketSchema
from src.repositories.sprocket import SprocketRepo

itemRepo = SprocketRepo()
itemSchema = SprocketSchema()
itemSchemaList = SprocketSchema(many=True)
